...
{
    public class MonochromeTextAdaptor : TextAdaptor
    {
        #region Fields
        ...
        public MonochromeTextAdaptor(int width, int height) : base(width, height)
        {
            _memory = new byte[_width * _height];
        }

        public MonochromeTextAdaptor(int width, int height, int scale) : base(width, height)
        {
            _memory = new byte[_width * _height];
            _scale = scale;
        }

        public MonochromeTextAdaptor(int width, int height, int scale, int aspect) : base(width, height)
        {
            _memory = new byte[_width * _height];
            _scale = scale;
            _aspect = aspect;
    ...
    {
        public static void SetPalette(Bitmap bitmap, TextAdaptor.ConsoleColor foreground, TextAdaptor.ConsoleColor background)
        {
        ...
        private static Color MapConsoleColorToColor(TextAdaptor.ConsoleColor consoleColor)
        {
            return consoleColor switch
            {
                TextAdaptor.ConsoleColor.Black => Color.Black,
                TextAdaptor.ConsoleColor.DarkBlue => Color.DarkBlue,
                TextAdaptor.ConsoleColor.DarkGreen => Color.DarkGreen,
                TextAdaptor.ConsoleColor.DarkCyan => Color.DarkCyan,
                TextAdaptor.ConsoleColor.DarkRed => Color.DarkRed,
                TextAdaptor.ConsoleColor.DarkMagenta => Color.DarkMagenta,
                TextAdaptor.ConsoleColor.DarkYellow => Color.Olive,
                TextAdaptor.ConsoleColor.Gray => Color.Gray,
                TextAdaptor.ConsoleColor.DarkGray => Color.DarkGray,
                TextAdaptor.ConsoleColor.Blue => Color.Blue,
                TextAdaptor.ConsoleColor.Green => Color.Green,
                TextAdaptor.ConsoleColor.Cyan => Color.Cyan,
                TextAdaptor.ConsoleColor.Red => Color.Red,
                TextAdaptor.ConsoleColor.Magenta => Color.Magenta,
                TextAdaptor.ConsoleColor.Yellow => Color.Yellow,
                TextAdaptor.ConsoleColor.White => Color.White,
