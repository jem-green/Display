...
{
    public class GraphicsDisplay : GraphicsMode, IStorage, IGraphic
    {
        #region Fields
		...
		public GraphicsDisplay(int width, int height) : base(width, height)
        {
            _x = 0;
            _y = 0;
        }

        public GraphicsDisplay(int width, int height, int scale) : base(width,height)
        {
            _x = 0;
            _y = 0;
            _scale = scale;
        ...
        public GraphicsDisplay(int width, int height, int scale, int aspect) : base(width, height)
        {
            _x = 0;
            _y = 0;
            _scale = scale;
