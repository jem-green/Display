...
namespace DisplayLibrary
{
    ...
    /// </summary>
    public class x : GraphicsMode, IStorage, IMode
    {
        #region Fields
        ...
        public x(int width, int height) : base(width, height)
        {
            _memory = new byte[_width * _height];
        }

        public x(int width, int height, int scale) : base(width, height)
        {
            _memory = new byte[_width * _height];
            _scale = scale;
        }

        public x(int width, int height, int scale, int aspect) : base(width, height)
        {
            _memory = new byte[_width * _height];
            _scale = scale;
            _aspect = aspect;
